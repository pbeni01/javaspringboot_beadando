...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Dec 01. 17:17
...
CREATE TABLE `film` (
  ...
  `filmcim` varchar(255) DEFAULT NULL,
  `szines` int(11) DEFAULT NULL,
  `szinkron` varchar(255) DEFAULT NULL,
  `szarmazas` varchar(255) DEFAULT NULL,
...
(22, 'Csodálatos Júlia', -1, 'mb', 'kanadai', 'nan', 104),
(23, 'Datolya', -1, 'fel', 'belga-francia-tunéziai', 'nan', 82),
...
(61, 'Az igazság fogságában', -1, 'fel', 'kanadai', 'nan', 108),
...
(91, 'Mennyország most', -1, 'fel', 'francia-német-holland-izrael', 'nan', 90),
...
(110, 'A Rashevski tangó', -1, 'fel', 'belga-luxemburgi-francia', 'nan', 90),
...
CREATE TABLE `mozi` (
  `moziazon` int(11) NOT NULL,
  `mozinev` varchar(255) DEFAULT NULL,
...
(1, 'A38 Hajó', '1113', 'Petõfi híd budai hídfõ', ''),
(2, 'Bárka Kikötõ a Ráday utcában', '1092', 'Ráday utca', ''),
(3, 'Bem', '1024', 'Margit krt. 5/b.', ''),
(4, 'Budapesti Európai Ifjúsági Központ', '1024', 'Zivatar u. 1-3.', ''),
(5, 'Cervantes Intézet', '1000', 'Vörösmarty u. 32.', ''),
(6, 'Cinema City Csepel Plaza', '1212', 'Rákóczi F. út 154-170.', ''),
(7, 'Cinema City Új Udvar', '1036', 'Bécsi út 38-44.', ''),
(8, 'Cirko-Gejzír', '1055', 'Balassi Bálint u. 15-17.', ''),
(9, 'Corvin Budapest Filmpalota', '1082', 'Corvin köz 1.', ''),
(10, 'Erlin 9 galéria', '1000', 'Ráday utca', ''),
(11, 'FilmesHáz', '1092', 'Ráday utca 31/K', ''),
(12, 'Hollywood Multiplex Duna Plaza', '1138', 'Váci út 178. (Duna Plaza)', ''),
(13, 'Hollywood Multiplex Lurdy Ház', '1092', 'Mester utca és Könyves Kálmán körút sarok', ''),
(14, 'Hollywood Multiplex Óbuda', '1030', 'Bécsi út 154. (Eurocenter)', ''),
(15, 'Hollywood Multiplex Pólus', '1152', 'Szentmihályi út 131.', ''),
(16, 'Hunnia', '1073', 'Erzsébet krt. 26.', ''),
(17, 'Jailhouse Club', '1094', 'IX. kerület, Tûzoltó utca 22.', ''),
(18, 'Jókai klub', '1121', 'Hollós út 5.', ''),
(19, 'Kis Erkel', '1000', 'Ráday utca', ''),
(20, 'Kossuth Mozi', '1132', 'Váci út 14.', ''),
(21, 'Kultiplex', '1095', 'Kinizsi u. 28.', ''),
(22, 'Millenáris Fogadó', '1024', 'Kisrókus u. 16-20.', ''),
(23, 'Mûcsarnok', '1406', 'Hõsõk tere', ''),
(24, 'Mûvész', '1066', 'Teréz krt. 30.', ''),
(25, 'Mûvészetek Palotája', '1095', 'Komor Marcell u. 1.', ''),
(26, 'Odeon-Lloyd mozi', '1136', 'Hollán Ernõ utca 7.', ''),
(27, 'Örökmozgó', '1073', 'Erzsébet krt. 39.', ''),
(28, 'Palace Campona', '1222', 'Nagytétényi út 37-43.', ''),
(29, 'Palace Mammut', '1024', 'Lövõház u. 2-6.', ''),
(30, 'Palace MOM Park', '1123', 'Alkotás út 53.', ''),
(31, 'Palace Westend', '1062', 'Váci út 1-3.', ''),
(32, 'Puskin', '1053', 'Kossuth L. u. 18.', ''),
(33, 'Ráday könyves ház', '1000', 'Ráday utca', ''),
(34, 'Sambhala Tibet Központ', '1088', 'Lõrinc pap tér 2.', ''),
(35, 'Science Park', '1117', 'Irínyi József u. 4.-20.', ''),
(36, 'Szimpla Kert Mozi', '1075', 'Kazinczy u. 14.', ''),
(37, 'Szindbád', '1137', 'Szent István krt. 16.', ''),
(38, 'Tabán', '1016', 'Krisztina krt. 87-89.', ''),
(39, 'Toldi', '1054', 'Bajcsy-Zsilinszky út 36-38.', ''),
(40, 'Tûzraktár', '1094', 'Tûzoltó u. 54-56', ''),
(41, 'Uránia Nemzeti Filmszínház', '1088', 'Rákóczi út 21.', ''),
(42, 'Vörösmarty', '1075', 'Üllõi út 4.', '');
...
(1, 'teszt', '$2a$10$zfHJ3YimbzJsg0mA/u7E7eQK54HtNL09gMwyx40qMOrGz5bEu1QxW', 'USER'),
(2, 'teszt2', '$2a$10$hEUB87d1jeIfF7IsQotVZeqJsjBYlNcMkaLpup1gua9C2NkoT9Ate', 'ADMIN');
